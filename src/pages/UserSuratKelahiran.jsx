...
import UserKelahiranInput from '../components/UserKelahiranInput'
                ...
                {loading ? <div className="w-full h-full justify-center items-center flex p-32  ">
                    ...
                    <div className="flex flex-col w-full h-full py-10 md:py-5 bg-blue-950/95 " >
                        ...
                        <div className="grid lg:grid-cols-2 w-full md:px-10 px-3 py-5 items-center">
                            <UserKelahiranInput onInfo={notifHandler} onLoading={handleLoading} />
                            <div className="items-center hidden lg:block  sm:max-w-sm mx-auto sm:w-full rounded-full ">
                                <img className='w-full object-scale-up ' src="/images/form-kelahiran.png" />
                            </div>
                        </div>
                    </div >}
                <FaqContent />
