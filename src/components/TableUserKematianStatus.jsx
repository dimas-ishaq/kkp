              ...
              <tr key={index} className="bg-gray-100 border-b" >
                ...
                <td className="text-sm text-gray-900 font-light px-2 py-3 whitespace-nowrap">
                  {item.status === 'diterima' ? (
                    ...
                    <button onClick={() => handleTarget(item._id, 'kematian')} className="rounded-md bg-red-500 w-full px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">
                      Batalkan
                    </button>
                  )}
                </td>
...
function TableUserKematianStatus({ itemsPerPage, items, handleTarget, handleInfo }) {
...
export default TableUserKematianStatus 